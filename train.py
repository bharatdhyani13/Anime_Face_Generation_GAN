...
def get_gen_normal(noise_shape):
    ...
    generator = Conv2DTranspose(filters = 1024, kernel_size = (4,4), strides = (1,1), padding = "valid", data_format = "channels_last", kernel_initializer = kernel_init)(gen_input)
...
def get_disc_normal(image_shape=(64,64,3)):
    ...
    discriminator = Conv2D(filters = 128, kernel_size = (4,4), strides = (2,2), padding = "same", data_format = "channels_last", kernel_initializer = kernel_init)(dis_input)
...
batch_size = 64
image_shape = None
img_save_dir = "/Users/bharatdh/Downloads/anime_pt2/output/"
save_model = True
image_shape = (64,64,3)
data_dir =  "/Users/bharatdh/Downloads/anime_pt2/data/*.png"
